...
public class TodocMasterDatabase_Impl extends TodocMasterDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `Task` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `projectId` INTEGER NOT NULL, `name` TEXT NOT NULL, `creationTimestamp` INTEGER NOT NULL, FOREIGN KEY(`projectId`) REFERENCES `Project`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE )");
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"60c1f1943b62190ea2e9f45c1a8e287a\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        ...
        _foreignKeysTask.add(new TableInfo.ForeignKey("Project", "CASCADE", "NO ACTION",Arrays.asList("projectId"), Arrays.asList("id")));
    ...
    }, "60c1f1943b62190ea2e9f45c1a8e287a", "d2e3b8af199ca30d171fcf1d61cb383c");
